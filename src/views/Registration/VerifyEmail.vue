...
<template>
    <div class="h-screen">
        <heading class="sm:p-0 px-3" heading="RITI ASSOCIATION  OF UNEMPLOYED PROFESSIONALS" desc="EMAIL VERIFICATION"></heading>
        <div class="flex mt-10">
            <div class="sm:flex sm:w-1/2 w-full justify-center px-10 items-center">
                <div class="mx-auto">
